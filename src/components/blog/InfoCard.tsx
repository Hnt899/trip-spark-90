...
const InfoCard = ({ data }: InfoCardProps) => {
  return (
    <div className="h-[600px] md:h-[750px] rounded-3xl shadow-sm bg-white overflow-hidden flex flex-col">
      {/* Верхняя часть - изображение */}
      <div className="h-[400px] md:h-[525px] bg-slate-50 flex items-center justify-center">
        <img
          src={data.image}
          alt={data.title}
      ...
      {/* Нижняя часть - текст */}
      <div className="h-[200px] md:h-[225px] bg-slate-50 px-6 pt-6 pb-2 flex flex-col justify-center">
