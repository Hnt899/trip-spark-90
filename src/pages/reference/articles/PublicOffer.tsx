    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container pt-24 md:pt-32 pb-12">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <span>/</span>
          <span>Публичная оферта раздела Ж/д билеты</span>
        </div>
        <h1 className="heading-gradient text-3xl md:text-4xl font-bold tracking-tight mb-6">Публичная оферта раздела Ж/д билеты</h1>
