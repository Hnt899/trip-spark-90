          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed mb-4">
                На GoTrip вы можете узнать расписание поездов «Сапсан», уточнить цены в разных классах, проверить наличие мест и купить билет онлайн.
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-base leading-relaxed">
                <p>
                  Заказ билетов на GoTrip займёт у вас около <strong>4 минут</strong>. Чтобы купить билет, укажите город отправления, прибытия и дату поездки. 
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-base leading-relaxed text-green-900">
                <p>
                  На GoTrip при покупке билетов на «Сапсан» применяются скидки для юных (от 5 лет до 21 года) и пожилых (от 60 лет) пассажиров. 
