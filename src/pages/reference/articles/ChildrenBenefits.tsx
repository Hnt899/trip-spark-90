              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-green-900">
                    ...
                    Размер скидки зависит от категории поезда, типа вагона, класса обслуживания и маршрута. На TudaSuda скидка применится автоматически, 
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-blue-900">
                    ...
                    Бесплатный билет без места можно оформить на TudaSuda вместе со взрослым билетом. Распространяется на детей с любым гражданством.
                  </p>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <p className="text-purple-900 mt-2">
                    Возраст пассажира определяется на момент отправления поезда. На TudaSuda скидка применяется автоматически, если возраст подходит под спецтариф. 
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <p className="text-purple-900 mt-2">
                    На TudaSuda скидка применяется автоматически, когда укажете возраст пассажира. Скидка не суммируется с другими льготами и тарифами.
                  </p>
                </div>
              </div>
            </CardContent>
