            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
                  <p>
                    После покупки на TudaSuda билет (посадочный купон) в формате pdf придет на электронную почту, указанную в заказе. 
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <p>
                  Чтобы отказаться от электронной регистрации, зайдите в личный кабинет TudaSuda. Вы можете отменить электронную регистрацию 
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  <p className="text-amber-900">
                    ...
                    в личном кабинете нет. При этом сдать билет онлайн в личном кабинете TudaSuda можно вплоть до отправления поезда со станции пассажира, 
