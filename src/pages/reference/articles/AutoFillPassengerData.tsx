  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container pt-24 md:pt-32 pb-12">
        ...
        <h1 className="heading-gradient text-3xl md:text-4xl font-bold tracking-tight mb-8">Упрощенный ввод данных пассажиров</h1>
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-6">
              ...
              <p className="text-lg leading-relaxed">
                Мы выполнили это пожелание: теперь купить ж/д билет на TudaSuda можно еще быстрее! Если вы уже покупали билеты на нашем сайте, 
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base leading-relaxed">
                      Если вы покупали билет на TudaSuda, у вас автоматически появился личный кабинет. Введите свою электронную почту и пароль 
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base leading-relaxed">
                      На странице ввода данных начните вводить фамилию пассажира, которому ранее покупали билет на TudaSuda.
                    </p>
                  </div>
                </div>
          ...
          <Card className="bg-muted/50">
            <CardContent className="p-6">
              <h2 className="heading-sub mb-4">Преимущества автоввода</h2>
