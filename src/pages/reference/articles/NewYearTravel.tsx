    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-12">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <span>/</span>
          <span>Поезд в Новый год. Идеи путешествий на новогодние праздники</span>
        </div>
        <h1 className="text-4xl font-bold mb-6">Поезд в Новый год. Идеи путешествий на новогодние праздники</h1>
