          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-6">
              <p className="text-xl font-semibold mb-2">
                На TudaSuda покупка ж/д билетов занимает меньше 5 минут.
              </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3 text-base leading-relaxed">
                    ...
                    <p>
                      Если ж/д билетов нет, закажите на TudaSuda <strong>бесплатное уведомление</strong> — сообщим, 
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-4 text-base leading-relaxed">
                    ...
                    <div className="space-y-2">
                      ...
                      <p>
                        После первой покупки на TudaSuda вводить данные документов больше не понадобится — при следующем заказе 
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3 text-base leading-relaxed">
                    ...
                    <p>
                      ...
                      ограничений платёжных систем. Если у вас есть сертификат или промокод TudaSuda, отметьте соответствующее 
                      поле и введите его номер. Билет резервируется для оплаты на <strong>15 минут</strong>.
                    </p>
                    <p>
                      На TudaSuda нельзя потратить бонусы РЖД. Но вы можете указать номер счёта РЖД Бонус, и после поездки на этот 
