          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-base leading-relaxed">
                ...
                <p>
                  На TudaSuda билеты с питанием обозначаются специальным значком в виде иконки вилки рядом с ложкой. Входит ли питание в стоимость проезда, можно понять по самому билету. 
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-base leading-relaxed">
                ...
                <p>
                  ...
                  При выборе билета на TudaSuda вагоны с предоплаченным питанием будут помечены специальным значком.
                </p>
                <p>
