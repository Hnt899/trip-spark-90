          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Это неполный список поездов с вагонами-ресторанами. Полный список включает более 200 поездов. При выборе билета на TudaSuda обратите внимание на карточку поезда — 
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-900 text-sm">
                  ...
                  Полный список доступен при поиске билетов на сайте TudaSuda.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                ...
                № 011/012 (Анапа — Москва, Санкт-Петербург — Мурманск), и многие другие. При выборе билета на TudaSuda вагоны-бистро также обозначаются специальным значком.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed text-blue-900">
                Чтобы узнать, есть ли в поезде вагон-ресторан или вагон-бистро, при выборе билета на TudaSuda обратите внимание на карточку поезда — 
