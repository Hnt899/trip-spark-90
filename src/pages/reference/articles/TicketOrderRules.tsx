        ...
        <div className="space-y-8">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <p>
                  ...
                  электронных писем и СМС-сообщений от сервиса GoTrip.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card id="limitations">
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                <p>
                  <strong>7.1.</strong> На GoTrip льготные билеты продаются только для детей. Льготные билеты для инвалидов, пенсионеров, ветеранов можно оформить только в кассе.
                </p>
          ...
          <Card id="refund">
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <p className="mb-3">
                  Купленный на GoTrip электронный билет можно сдать в личном кабинете на нашем сайте или в железнодорожной кассе. 
