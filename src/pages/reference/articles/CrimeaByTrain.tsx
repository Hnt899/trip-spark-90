        ...
        <div className="space-y-8">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                  <p className="text-blue-900">
                    ...
                    подпишитесь на бесплатное уведомление от TudaSuda. Мы пришлём напоминание, когда откроются продажи или кто-то сдаст билет. 
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                <p>
                  В Крым из разных городов России ходят автобусы. Расписание и билеты есть на TudaSuda, например:
                </p>
                ...
                <p>
                  Чтобы поездка была комфортной, выбирайте перевозчика по рейтингу и отзывам. При выборе рейса на TudaSuda нажмите на ссылку «Отзывы». 
