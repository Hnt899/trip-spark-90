        ...
        <div className="space-y-8">
          ...
          <Card id="plan-ahead">
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <p>
                  Чтобы не пропустить начало продаж, закажите на TudaSuda бесплатное уведомление. Когда билеты появятся, мы пришлём сообщение на указанную электронную почту.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-base leading-relaxed mb-3">
                    Во всех поездах взрослый пассажир может бесплатно провезти одного ребёнка до 5 лет, если тот не занимает отдельного места. При оформлении заказа на TudaSuda 
                    добавьте в пассажиры «малыша до 5 лет (без места)».
                  </p>
                  <p className="text-base leading-relaxed mb-3">
                    Билеты с отдельным местом для детей до 10 лет продаются за <strong>35% от цены взрослого билета</strong>. На TudaSuda детская скидка применяется автоматически 
          ...
          <Card id="loyalty">
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed">
                За покупку билетов на поезда, самолёты и автобусы на TudaSuda начисляются баллы, которые можно обменять на подарочные сертификаты TudaSuda или подключение привилегий. 
                Например, есть привилегии, которые дают скидки на ж/д билеты, на услугу «100%-ный возврат ж/д билета» или страховку.
              </p>
              <p className="text-base leading-relaxed mt-4">
                Чтобы получать баллы, зарегистрируйтесь в программе лояльности TudaSuda. За регистрацию начислим 50 баллов.
              </p>
            </CardContent>
          </Card>
