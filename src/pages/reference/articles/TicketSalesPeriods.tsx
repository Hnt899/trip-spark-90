              ...
              <div className="space-y-3 text-base leading-relaxed">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  <p className="text-amber-900">
                    ...
                    В том числе за 90 дней продаются билеты на поезда в Калининград. К сожалению, их нельзя купить на TudaSuda, а только в кассе на вокзале или на сайте перевозчика, 
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-base leading-relaxed">
                ...
                <p>
                  Чтобы не упустить билеты, закажите на TudaSuda бесплатное уведомление о старте продаж. Когда билеты появятся в продаже, вы получите электронное письмо.
                </p>
                <p>
