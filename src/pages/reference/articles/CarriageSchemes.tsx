          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed mt-3">
                При покупке билета на сайте GoTrip пассажиры выбирают места или на схеме вагона поезда, или указывая только диапазон мест. 
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed text-blue-900">
                Схема вагона с местами обычно висит около кассы на вокзале. Это не значит, что теперь придется туда ехать – при покупке билета на GoTrip 
