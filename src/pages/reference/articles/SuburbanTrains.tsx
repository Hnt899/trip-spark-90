        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-6">Как купить билет на скорые пригородные поезда на сайте GoTrip</h2>
              <p className="text-base leading-relaxed mb-4">
                На GoTrip можно купить билеты на скорые пригородные поезда с предоставлением места.
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-base leading-relaxed mb-4">
                На GoTrip можно купить билеты на скорые пригородные поезда формирования ЦППК с предоставлением мест, следующие по маршрутам:
              </p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                <p>
                  Вернуть билет, купленный на GoTrip, можно в личном кабинете. Процедура возврата похожа на возврат ж/д билета на поезда дальнего следования.
                </p>
                <p>
                ...
                <div className="bg-primary/5 rounded-lg p-4 border border-primary/20 mt-4">
                  ...
                  <ul className="space-y-2">
                    <li>
                      ...
                      сервисных сборов GoTrip и партнеров, а также комиссии платежных систем.
                    </li>
                    <li>
                      ...
                      за вычетом сервисных сборов GoTrip и партнеров, а также комиссии платежных систем.
                    </li>
                    <li>
