          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-6">
              <p className="text-lg leading-relaxed">
                Вернуть купленные на GoTrip билеты можно в личном кабинете или в кассе РЖД. Сдавать билет онлайн удобнее — 
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mb-4">
                    ...
                    <li>сервисный сбор GoTrip, оплаченный при покупке;</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mb-4">
                    ...
                    <li>сервисный сбор GoTrip, уплаченный при покупке билета;</li>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-base leading-relaxed">
                ...
                <p>
                  ...
                  и услуг РЖД — например, дополнительного багажа и питания, если вы их оплачивали. Для этого зайдите в раздел «Заказы» в профиле GoTrip, 
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>сбор РЖД за возврат;</li>
                  <li>сервисный сбор GoTrip, оплаченный при покупке билета;</li>
                  <li>сбор за оформление онлайн-возврата, если возврат оформляется на сайте или в приложении. Размер сбора — 3,5% от стоимости 
                      каждого билета у перевозчика, но не меньше 20 рублей и не больше 500 рублей.</li>
                </ul>
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
